...
,Platform, StatusBar, Image } from 'react-native';
import { Container, Content, Header, Left, Right, 
  Icon, Item,Input, Card,CardItem } from 'native-base'
import FAIcon from 'react-native-vector-icons/FontAwesome'

import Swiper from 'react-native-swiper';

import RecommededCardItem from '../components/RecommendedCardItem';
      ...
      <Container>
        ...
        borderBottomColor: '#757575'}, styles.AndroidHeader]}>
            <Left style={{flexDirection:'row'}}>
                <Icon onPress={() => this.props.navigation.navigate
                ('DrawerOpen')} name="md-menu" style={{color:'white', 
            marginRight: 15}}/>
                <FAIcon name="amazon" style={{size: 32, color: 'white'}}/>
            </Left>
          ...
          <View style ={{
              position :'absolute', left:0, right:0,top:90, height:70,
          ...
          justifyContent: 'space-between', alignItems:'center'}}>
            ...
            <Swiper autoplay={true} style ={{height:100}}>
              <View style={{flex:1}}>
                <Image 
                style={{flex:1,hieght: null,width:null, resizeMode:'contain'}}
